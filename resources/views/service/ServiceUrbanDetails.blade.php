                ...
                <div class="w-full lg:w-1/2 px-4 mt-8 lg:mt-0" id="urban-services-right">
                    @if($urbanService)
                        <div class="grid grid-cols-2 gap-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2"
                            ...
                            @if($urbanService->imgOne)
                                <div>
                                    <img src="{{ asset($urbanService->imgOne) }}" alt="Building Design 1" class="urban-image">
                                </div>
                            @endif
                            @if($urbanService->imgTwo)
                                <div>
                                    <img src="{{ asset($urbanService->imgTwo) }}" alt="Building Design 2" class="urban-image">
                                </div>
                            @endif
                            @if($urbanService->imgThree)
                                <div>
                                    <img src="{{ asset($urbanService->imgThree) }}" alt="Interior Design 1" class="urban-image">
                                </div>
                            @endif
                            @if($urbanService->imgFour)
                                <div>
                                    <img src="{{ asset($urbanService->imgFour) }}" alt="Office Design" class="urban-image">
                                </div>
                            @endif
                        </div>
                    @else
