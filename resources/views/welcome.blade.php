...
<body class="antialiased bg-fixed bg-no-repeat bg-cover"
    ...
    <section class="bg-white ">
        ...
        <div class="flex items-center justify-between bg-transparent p-4">

            <!-- Logo Section -->
            <div class="flex items-center" style="margin-left: 4%;margin-top: 5%;width: 41%;">
                <img src="photo/transforming-1.png" alt="Logo" class="border border-white p-1" />
            </div>

            <!-- Services Section -->
            <div class="mx-auto mt-24 mb-20 max-w-2xl text-center p-6 dark:bg-gray-900">
                <h2 class="mb-12 text-center text-gray-900 dark:text-gray-200 sm:text-5xl"
                    style="font-size: 42px;color:#202020;font-family: fantasy;">Who We Are</h2>
    ...
    <section class="py-12 bg-white relative">
        ...
        <div class="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6 px-6 lg:px-20 relative z-10">
            ...
            <div class="flex flex-col justify-center space-y-4 text-center lg:text-center bg-white p-6"
                ...
                <h3 class="text-3xl font-bold uppercase">Our Mission</h3>
            ...
            <div class="flex flex-col justify-center space-y-4 text-center lg:text-center bg-white p-6"
                style="box-shadow: rgba(0, 0, 0, 0.45) -10px 25px 20px -20px, rgba(0, 0, 0, 0.45) 10px 25px 20px -20px;">
                <h3 class="text-3xl font-bold uppercase">Our Vision</h3>
                <p class="text-gray-500 text-lg" style="text-align: justify;">
        ...
        <div class="p-24 flex flex-wrap items-center justify-center" style="margin-top: -10%;">
            ...
            <div class="flex-shrink-0 m-6 relative overflow-hidden  rounded-lg max-w-xs shadow-lg"
                ...
                <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none"
                    style="transform: scale(1.5); opacity: 0.6;">
                    <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)"
                        fill="white" />
                    <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white" />
                </svg>
                <div class="relative pt-10 px-10 flex items-center justify-center">
                    <img class="relative w-60" src="photo/icon/skyscraper.png" alt="">
                </div>
                <div class="relative text-black px-6 pb-6 mt-6">
                    <div class="flex justify-between">
                        <span class="block font-semibold text-xl"
                            style="margin-left: 32%;margin-top: -49px;font-size: 35px;font-family: math;">Urban</span>
                    </div>
                </div>
            </div>
            <div class="flex-shrink-0 m-6 relative overflow-hidden  rounded-lg max-w-xs shadow-lg"
                ...
                <div class="relative pt-10 px-10 flex items-center justify-center">
                    <img class="relative w-60" src="photo/icon/rural-house.png" alt="" style="width: 83%;">
                </div>
                <div class="relative text-black px-6 pb-6 mt-6">
                    <div class="flex justify-between">
                        <span class="block font-semibold text-xl"
            ...
            <div class="flex-shrink-0 m-6 relative overflow-hidden  rounded-lg max-w-xs shadow-lg"
                ...
                <div class="relative pt-10 px-10 flex items-center justify-center">
                    <img class="relative w-60" src="photo/icon/earth-globe-with-continents-maps.png" alt=""
                        style="width: 83%;">
                </div>
                <div class="relative text-black px-6 pb-6 mt-6">
                    <div class="flex justify-between">
                        <span class="block font-semibold text-xl"
                            style="margin-left: 18%;margin-top:1px;font-size: 35px;font-family: math;">Internationl</span>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 bg-white relative">
        ...
        <form action="https://fabform.io/f/xxxxx" method="post"
            style="background: rgba(255, 255, 255, 0.14);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(2.5px);-webkit-backdrop-filter: blur(2.5px);">
            ...
            <div
                    ...
                    <div class="mt-4">
                        <div class="flex space-x-4 mt-2">
                            ...
                            <a href="https://facebook.com" target="_blank"
                                class="bg-blue-600 p-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">
                            ...
                            <a href="https://twitter.com" target="_blank"
                                class="bg-blue-400 p-2 rounded-lg shadow-md hover:bg-blue-500 transition duration-300">
                            ...
                            <a href="https://linkedin.com" target="_blank"
                                class="bg-blue-800 p-2 rounded-lg shadow-md hover:bg-blue-900 transition duration-300">
                            ...
                            <a href="https://wa.me/" target="_blank"
                                class="bg-green-600 p-2 rounded-lg shadow-md hover:bg-green-700 transition duration-300">
                ...
                <div class="space-y-8">
                    ...
                    <!-- Upload Sketch Field -->
                    <div>
                        <label for="sketch" class="uppercase text-sm text-gray-600 font-bold">Upload Sketch</label>
                        <input name="sketch" id="sketch"
                            class="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
