            ...
            <main class="bg-[#f3f3f9] mb-auto flex-grow">
                <div class="container mx-auto px-4 py-8">
                    <div class="bg-white p-10 rounded-lg shadow-xl"
                        ...
                        <h2 class="text-3xl font-semibold text-gray-800 mb-8 text-center">Network</h2>

                        <!-- Form Start -->
                        <form action="{{ url('/a-network') }}" method="POST" enctype="multipart/form-data">
                            @csrf
