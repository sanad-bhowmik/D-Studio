<div class="bg-white p-8" id="network"
    style="padding-left: 9%;padding-right: 3%;border-bottom: 2px solid #2f3543;font-family:'Nunito', serif;">
    ...
    <div id="lines"
        style="margin-top: 32px;background-color: #FFBF00;padding: 6px;margin-left: -112px;width: 1248px;margin-bottom: -32px;">
    </div>
</div>
<style>
    h2 {
