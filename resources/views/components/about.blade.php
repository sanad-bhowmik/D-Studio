<div class="bg-white py-8" id="about-us-section">
    <div>
        <h1 class="about-us-title"
            style="font-family: math; text-transform: uppercase; font-size: 27px; margin-right: 12%; text-align:end;">
            About Us
        </h1>
        <div class="flex flex-wrap items-center about-us-content"
            ...
            <div class="w-full md:w-2/3 px-4 md:px-16 about-us-text">
                <div class="flex flex-col md:flex-row justify-between">
                    ...
                    <!-- Mission Section -->
                    <div class="text-end w-full md:w-2/3 about-us-mission" style="margin-right: 8%;">
                        <!-- Mission Image -->
                        <div class="mb-4">
                            <img src="{{ asset($aboutData->rightImg) }}" alt="Mission Image" class="w-full h-auto"
