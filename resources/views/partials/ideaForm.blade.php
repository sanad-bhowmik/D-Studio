...
<body>
    <!-- component -->
    <div class="flex justify-center items-center w-screen h-screen" style="position: relative; overflow: hidden;">
        <!-- Background Layer -->
        <div
            style="background-image: url('Photo/background.png');background-size: cover;background-position: center;background-attachment: fixed;opacity: 0.1;position: absolute;top: 0;left: 0;width: 100%;height: 100%;z-index: -1;">
        </div>
        <!-- COMPONENT CODE -->
        <div class="container mx-auto my-4 px-4 lg:px-20 form-oo  " style="">
            <div class="bg-white w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl"
                style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;margin-top: -77px;border: 1px solid #f59e0b;">
                <div class="flex">
                ...
                <form id="ideaForm" action="{{ route('ideaForm.submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex gap-2">
                        <!-- Send Us Button -->
                        <button type="submit"
                            class="uppercase text-sm font-bold tracking-wide bg-yellow-500 text-gray-100 p-3 rounded-lg w-32 focus:outline-none focus:shadow-outline">
                            Send Us
                        </button>
                        <a href="/">
                            <button type="button"
            ...
            <div class="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-yellow-500 rounded-2xl" id="quote">
                <div class="flex flex-col text-white">
                    <h1 class="font-bold uppercase text-4xl my-4">DSTUDIO</h1>
                    <div class="flex my-4 w-2/3 lg:w-1/2">
                        <div class="flex flex-col">
                            <p class="text-white-300 text-2xl italic"> Your Distant Design Partner</p>
                        </div>
                    </div>
                </div>
            </div>
