    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
            <a href="https://pagedone.io/" class="flex">
                <img src="photo/logo2.png" alt="" style="width: 27%;">
            </a>
            <div class="flex items-center gap-4">
                <a href="javascript:;"
                    class="p-3 rounded-full bg-white text-gray-700 group transition-all duration-500 hover:bg-amber-500 hover:text-white hover:bg-black focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white">
        ...
        <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
            <span class="text-sm font-normal text-gray-400">
                <a href="https://pagedone.io/" class="">©d-studio</a> 2025, All rights reserved.
            </span>
            <div class="relative  text-gray-500 focus-within:text-gray-900 ">
                <p
                    ...
                    <a href="https://playon24.com.bd/">
                        <span style="color: #003855; font-weight: 700;">PlayOn <span style="color: #f34a14;">24</span>
                        </span>
                    </a>
                </p>
            </div>
